...
namespace DirectSports
{
    public partial class volleyball : System.Web.UI.Page
    {
        ...
        {
            plLegea.DataSource = ProductSectionEntity.LoadProductsForSection(50);
            plLegea.DataBind();

            plStanno.DataSource = ProductSectionEntity.LoadProductsForSection(51);
            plStanno.DataBind();

            vbVolleyballs.ProductList = ProductSectionEntity.LoadProductsForSection(52);
            vbVolleyballs.DataBind();
        }

        protected void plLegea_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
        ...
        protected void plStanno_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ProductEntity pe = e.Item.DataItem as ProductEntity;
            HtmlImage imgMainProductImage = e.Item.FindControl("imgProductImage") as HtmlImage;
            imgMainProductImage.Src = WebConfigurationManager.AppSettings["ProductImagesPath"] + pe.ImageName;
