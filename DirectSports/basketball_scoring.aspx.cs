...
{
    public partial class basketball_scoring : System.Web.UI.Page
    {
        ...
        {
            plBasketballScoring.DataSource = ProductSectionEntity.LoadProductsForSection(6);
            plBasketballScoring.DataBind();
        }

        protected void plBasketballScoring_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
