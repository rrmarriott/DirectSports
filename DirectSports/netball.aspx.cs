...
namespace DirectSports
{
    public partial class netball : System.Web.UI.Page
    {
        ...
        {
            plNetballKit.DataSource = ProductSectionEntity.LoadProductsForSection(19);
            plNetballKit.DataBind();

            listNetballEquipment.ProductList = ProductSectionEntity.LoadProductsForSection(32);
        }

        protected void plNetballKit_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
