...
namespace DirectSports
{
    public partial class badminton : System.Web.UI.Page
    {
        ...
        {
            plBadmintonImages.DataSource = ProductSectionEntity.LoadProductsForSection(61);
            plBadmintonImages.DataBind();
        }

        protected void plBadmintonImages_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
