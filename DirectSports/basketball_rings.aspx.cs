...
{
    public partial class basketball_rings : System.Web.UI.Page
    {
        ...
        {
            plBasketballRingsImages.DataSource = ProductSectionEntity.LoadProductsForSection(8);
            plBasketballRingsImages.DataBind();
        }

        protected void plBasketballRingsImages_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
