...
{
    public partial class football_balls : System.Web.UI.Page
    {
        ...
        {
            plFootballBallsImages.DataSource = ProductSectionEntity.LoadProductsForSection(15);
            plFootballBallsImages.DataBind();
        }

        protected void plFootballBallsImages_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
