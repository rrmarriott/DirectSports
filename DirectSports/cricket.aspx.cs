...
namespace DirectSports
{
    public partial class cricket : System.Web.UI.Page
    {
        ...
        {
            plCricketImages.DataSource = ProductSectionEntity.LoadProductsForSection(12);
            plCricketImages.DataBind();
        }

        protected void plCricketImages_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
