...
{
    public partial class basketball_accessoriesandref : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            BindLists();
            imgRefShirt.Src = WebConfigurationManager.AppSettings["ProductImagesPath"] + "ds_ref_shirt.jpg";
        }

        private void BindLists()
        {
            plBasketballImages.DataSource = ProductSectionEntity.LoadProductsForSection(5);
            plBasketballImages.DataBind();

            refList.ProductList = ProductSectionEntity.LoadProductsForSection(28);
        }
