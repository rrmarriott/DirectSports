...
{
    public partial class football_clothing : System.Web.UI.Page
    {
        ...
        {
            plFootballClothingLegea.DataSource = ProductSectionEntity.LoadProductsForSection(17);
            plFootballClothingLegea.DataBind();

            plFootballClothingMacron.DataSource = ProductSectionEntity.LoadProductsForSection(64);
            plFootballClothingMacron.DataBind();
        }

        protected void plFootballClothing_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
