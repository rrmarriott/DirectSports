...
namespace DirectSports
{
    public partial class hockey : System.Web.UI.Page
    {
        ...
        {
            plHockeyClothing.DataSource = ProductSectionEntity.LoadProductsForSection(18);
            plHockeyClothing.DataBind();

            listHockeyEquipment.ProductList = ProductSectionEntity.LoadProductsForSection(31);
        }

        protected void plHockeyClothing_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
