...
namespace DirectSports.BL.DatabaseSpecific
{
	...
	internal class PersistenceInfoFactory
	{
		...
		private static PersistenceInfoBucket CreatePersistenceInfoBucket(string objectName)
		{
			...
			switch(objectName)
			{
				...
				case "ProductSectionEntity":
					...
					break;
				case "ProductVariationEntity":
					toReturn = CreateProductVariationEntityBucket();
					break;
				case "RoleEntity":
		...
		private static PersistenceInfoBucket CreateProductEntityBucket()
		{
			...
			toReturn.AddFieldPersistenceInfo("SortIndex", new FieldPersistenceInfo(@"Default", "Product", "SortIndex", true, (int)OleDbType.SmallInt, 0, 0, 5, false, "", null, typeof(System.Int16)));
			toReturn.AddFieldPersistenceInfo("Enabled", new FieldPersistenceInfo(@"Default", "Product", "Enabled", false, (int)OleDbType.Boolean, 2, 0, 0, false, "", null, typeof(System.Boolean)));
