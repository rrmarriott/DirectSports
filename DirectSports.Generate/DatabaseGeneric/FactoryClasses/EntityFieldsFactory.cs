...
namespace DirectSports.BL.FactoryClasses
{
	...
	public partial class EntityFieldsFactory
	{
		...
		public static IEntityFields2 CreateEntityFieldsObject(EntityType relatedEntityType)
		{
			...
			switch(relatedEntityType)
			{
				...
				case DirectSports.BL.EntityType.ProductVariationEntity:
					fieldsToReturn = CreateProductVariationEntityFields();
					break;
		...
		/// <summary>Creates a complete EntityFields instance for the ProductVariationEntity.</summary>
		private static IEntityFields2 CreateProductVariationEntityFields()
		{

			IEntityFields2 fieldsToReturn = new EntityFields2((int)ProductVariationFieldIndex.AmountOfFields, InheritanceInfoProviderSingleton.GetInstance());
			for(int i=0;i<(int)ProductVariationFieldIndex.AmountOfFields;i++)
			{
				fieldsToReturn[i] = EntityFieldFactory.Create((ProductVariationFieldIndex)i);
			}
			return fieldsToReturn;
		}
