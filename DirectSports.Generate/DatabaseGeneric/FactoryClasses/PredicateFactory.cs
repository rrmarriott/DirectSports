...
namespace DirectSports.BL.FactoryClasses
{
	...
	public partial class PredicateFactory
	{
		...
		/// <summary>FieldCompareValuePredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareValuePredicate CompareValue(ProductVariationFieldIndex indexOfField, ComparisonOperator operatorToUse, object value)
		{
			return new FieldCompareValuePredicate(EntityFieldFactory.Create(indexOfField), null, operatorToUse, value);
		}
		
		/// <summary>FieldCompareValuePredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareValuePredicate CompareValue(ProductVariationFieldIndex indexOfField, ComparisonOperator operatorToUse, object value, bool negate)
		{
			return new FieldCompareValuePredicate(EntityFieldFactory.Create(indexOfField), null, operatorToUse, value, negate);
		}

		/// <summary>FieldCompareValuePredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareValuePredicate CompareValue(ProductVariationFieldIndex indexOfField, ComparisonOperator operatorToUse, object value, string objectAlias)
		{
			return new FieldCompareValuePredicate(EntityFieldFactory.Create(indexOfField), null, operatorToUse, value, objectAlias);
		}
		
		/// <summary>FieldCompareValuePredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareValuePredicate CompareValue(ProductVariationFieldIndex indexOfField, ComparisonOperator operatorToUse, object value, string objectAlias, bool negate)
		{
			return new FieldCompareValuePredicate(EntityFieldFactory.Create(indexOfField), null, operatorToUse, value, objectAlias, negate);
		}
		...
		/// <summary>FieldCompareNullPredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareNullPredicate CompareNull(ProductVariationFieldIndex indexOfField)
		{
			return new FieldCompareNullPredicate(EntityFieldFactory.Create(indexOfField), null);
		}

		/// <summary>FieldCompareNullPredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareNullPredicate CompareNull(ProductVariationFieldIndex indexOfField, bool negate)
		{
			return new FieldCompareNullPredicate(EntityFieldFactory.Create(indexOfField), null, negate);
		}

		/// <summary>FieldCompareNullPredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareNullPredicate CompareNull(ProductVariationFieldIndex indexOfField, string objectAlias)
		{
			return new FieldCompareNullPredicate(EntityFieldFactory.Create(indexOfField), null, objectAlias);
		}

		/// <summary>FieldCompareNullPredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareNullPredicate CompareNull(ProductVariationFieldIndex indexOfField, string objectAlias, bool negate)
		{
			return new FieldCompareNullPredicate(EntityFieldFactory.Create(indexOfField), null, objectAlias, negate);
		}
		...
		/// <summary>FieldBetweenPredicate factory for ProductVariationEntity.</summary>
		public static FieldBetweenPredicate Between(ProductVariationFieldIndex indexOfField, object valueBegin, object valueEnd)
		{
			return new FieldBetweenPredicate(EntityFieldFactory.Create(indexOfField), null, valueBegin, valueEnd);
		}

		/// <summary>FieldBetweenPredicate factory for ProductVariationEntity.</summary>
		public static FieldBetweenPredicate Between(ProductVariationFieldIndex indexOfField, object valueBegin, object valueEnd, bool negate)
		{
			return new FieldBetweenPredicate(EntityFieldFactory.Create(indexOfField), null, valueBegin, valueEnd, negate);
		}

		/// <summary>FieldBetweenPredicate factory for ProductVariationEntity.</summary>
		public static FieldBetweenPredicate Between(ProductVariationFieldIndex indexOfField, object valueBegin, object valueEnd, string objectAlias)
		{
			return new FieldBetweenPredicate(EntityFieldFactory.Create(indexOfField), null, valueBegin, valueEnd, objectAlias);
		}

		/// <summary>FieldBetweenPredicate factory for ProductVariationEntity.</summary>
		public static FieldBetweenPredicate Between(ProductVariationFieldIndex indexOfField, object valueBegin, object valueEnd, string objectAlias, bool negate)
		{
			return new FieldBetweenPredicate(EntityFieldFactory.Create(indexOfField), null, valueBegin, valueEnd, objectAlias, negate);
		}
		...
		/// <summary>FieldLikePredicate factory for ProductVariationEntity.</summary>
		public static FieldLikePredicate Like(ProductVariationFieldIndex indexOfField, string pattern)
		{
			return new FieldLikePredicate(EntityFieldFactory.Create(indexOfField), null, pattern);
		}

		/// <summary>FieldLikePredicate factory for ProductVariationEntity.</summary>
		public static FieldLikePredicate Like(ProductVariationFieldIndex indexOfField, string pattern, bool negate)
		{
			return new FieldLikePredicate(EntityFieldFactory.Create(indexOfField), null, pattern, negate);
		}

		/// <summary>FieldLikePredicate factory for ProductVariationEntity.</summary>
		public static FieldLikePredicate Like(ProductVariationFieldIndex indexOfField, string objectAlias, string pattern)
		{
			return new FieldLikePredicate(EntityFieldFactory.Create(indexOfField), null, objectAlias, pattern);
		}

		/// <summary>FieldLikePredicate factory for ProductVariationEntity.</summary>
		public static FieldLikePredicate Like(ProductVariationFieldIndex indexOfField, string objectAlias, string pattern, bool negate)
		{
			return new FieldLikePredicate(EntityFieldFactory.Create(indexOfField), null, objectAlias, pattern, negate);
		}
		...
		/// <summary>FieldCompareRangePredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareRangePredicate CompareRange(ProductVariationFieldIndex indexOfField, params object[] values)
		{
			return new FieldCompareRangePredicate(EntityFieldFactory.Create(indexOfField), null, values);
		}
		
		/// <summary>FieldCompareRangePredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareRangePredicate CompareRange(ProductVariationFieldIndex indexOfField, bool negate, params object[] values)
		{
			return new FieldCompareRangePredicate(EntityFieldFactory.Create(indexOfField), null, negate, values);
		}

		/// <summary>FieldCompareRangePredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareRangePredicate CompareRange(ProductVariationFieldIndex indexOfField, string objectAlias, params object[] values)
		{
			return new FieldCompareRangePredicate(EntityFieldFactory.Create(indexOfField), null, objectAlias, values);
		}
		
		/// <summary>FieldCompareRangePredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareRangePredicate CompareRange(ProductVariationFieldIndex indexOfField, string objectAlias, bool negate, params object[] values)
		{
			return new FieldCompareRangePredicate(EntityFieldFactory.Create(indexOfField), null, objectAlias, negate, values);
		}
		...
		/// <summary>FieldCompareExpressionPredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareExpressionPredicate CompareExpression(ProductVariationFieldIndex indexOfField, ComparisonOperator operatorToUse, IExpression expressionToCompareWith)
		{
			return new FieldCompareExpressionPredicate(EntityFieldFactory.Create(indexOfField), null, operatorToUse, expressionToCompareWith );
		}
		
		/// <summary>FieldCompareExpressionPredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareExpressionPredicate CompareExpression(ProductVariationFieldIndex indexOfField, ComparisonOperator operatorToUse, IExpression expressionToCompareWith, bool negate)
		{
			return new FieldCompareExpressionPredicate(EntityFieldFactory.Create(indexOfField), null, operatorToUse, expressionToCompareWith, negate);
		}

		/// <summary>FieldCompareExpressionPredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareExpressionPredicate CompareExpression(ProductVariationFieldIndex indexOfField, ComparisonOperator operatorToUse, IExpression expressionToCompareWith, string objectAlias)
		{
			return new FieldCompareExpressionPredicate(EntityFieldFactory.Create(indexOfField), null, operatorToUse, expressionToCompareWith, objectAlias);
		}
		
		/// <summary>FieldCompareExpressionPredicate factory for ProductVariationEntity.</summary>
		public static FieldCompareExpressionPredicate CompareExpression(ProductVariationFieldIndex indexOfField, ComparisonOperator operatorToUse, IExpression expressionToCompareWith, string objectAlias, bool negate)
		{
			return new FieldCompareExpressionPredicate(EntityFieldFactory.Create(indexOfField), null, operatorToUse, expressionToCompareWith, objectAlias, negate);
		}
