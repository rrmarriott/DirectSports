...
// Code is generated on: 05 September 2006 21:07:04
...
{
	/// <summary>
	/// Implementation of the ProductSection Validator class. This class formulates validation rules for the
	/// ProductSectionEntity class. It is plugged into an instance of the ProductSectionEntity class using the Strategy
	...
	/// ProductSectionEntity class instead of an instance of this class. The ProductSectionEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class ProductSectionValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductSectionValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add ProductSectionValidator.Validate implementation
			return true ;
