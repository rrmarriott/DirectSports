...
{
	/// <summary>
	/// Implementation of the UserRoleLink Validator class. This class formulates validation rules for the
	/// UserRoleLinkEntity class. It is plugged into an instance of the UserRoleLinkEntity class using the Strategy
	...
	/// UserRoleLinkEntity class instead of an instance of this class. The UserRoleLinkEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class UserRoleLinkValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public UserRoleLinkValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add UserRoleLinkValidator.Validate implementation
			return true ;
