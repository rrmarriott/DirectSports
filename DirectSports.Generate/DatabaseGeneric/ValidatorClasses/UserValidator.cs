...
{
	/// <summary>
	/// Implementation of the User Validator class. This class formulates validation rules for the
	/// UserEntity class. It is plugged into an instance of the UserEntity class using the Strategy
	...
	/// UserEntity class instead of an instance of this class. The UserEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class UserValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add UserValidator.Validate implementation
			return true ;
