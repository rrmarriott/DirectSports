...
{
	/// <summary>
	/// Implementation of the Role Validator class. This class formulates validation rules for the
	/// RoleEntity class. It is plugged into an instance of the RoleEntity class using the Strategy
	...
	/// RoleEntity class instead of an instance of this class. The RoleEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class RoleValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add RoleValidator.Validate implementation
			return true ;
