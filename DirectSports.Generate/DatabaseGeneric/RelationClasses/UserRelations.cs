...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: User.
	...
	public partial class UserRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between UserEntity and UserRoleLinkEntity over the 1:n relation they have, using the relation between the fields:
		/// User.UserId - UserRoleLink.UserId
		/// </summary>
		public virtual IEntityRelation UserRoleLinkEntityUsingUserId
		{
			get
			{
