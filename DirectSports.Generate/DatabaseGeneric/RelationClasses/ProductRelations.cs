...
namespace DirectSports.BL.RelationClasses
{
	...
	public partial class ProductRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between ProductEntity and ProductVariationEntity over the 1:n relation they have, using the relation between the fields:
		/// Product.Id - ProductVariation.ProductId
		/// </summary>
		public virtual IEntityRelation ProductVariationEntityUsingProductId
		{
			get
			{
				...
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ProductEntity", true);
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ProductVariationEntity", false);
				return relation;
			}
		}
