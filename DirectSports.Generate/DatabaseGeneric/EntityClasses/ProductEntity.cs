...
namespace DirectSports.BL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection _productVariation;
		...
		/// <summary> Event which is thrown when SortIndex changes value. Databinding related.</summary>
		public event EventHandler SortIndexChanged;
		/// <summary> Event which is thrown when Enabled changes value. Databinding related.</summary>
		...
		protected ProductEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			_productVariation = (EntityCollection)info.GetValue("_productVariation", typeof(EntityCollection));
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "ProductVariation":
					this.ProductVariation.Add((ProductVariationEntity)entity);
					break;
		...
		public override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "SpecialOffer":
					...
					break;
				case "ProductVariation":
					this.ProductVariation.Add(relatedEntity);
					break;
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "SpecialOffer":
					...
					break;
				case "ProductVariation":
					this.ProductVariation.Remove(relatedEntity);
					break;
		...
		public override ArrayList GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.ProductVariation);
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue("_productVariation", _productVariation);
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch
		/// the related entities of type 'ProductVariation' to this entity. Use DataAccessAdapter.FetchEntityCollection() to fetch these related entities.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoProductVariation()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(EntityFieldFactory.Create(ProductVariationFieldIndex.ProductId), null, ComparisonOperator.Equal, this.Id));
			return bucket;
		}
		...
		/// <summary> Event thrower for the SortIndexChanged event, which is thrown when SortIndex changes value. Databinding related.</summary>
		protected virtual void OnSortIndexChanged()
		{
			if(SortIndexChanged!=null)
			{
				SortIndexChanged(this, new EventArgs());
			}
		}

		/// <summary> Event thrower for the EnabledChanged event, which is thrown when Enabled changes value. Databinding related.</summary>
		...
		protected override void AddInternalsToContext()
		{
			...
			{
				_productVariation.ActiveContext = base.ActiveContext;
			}
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'ProductVariation' 
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathProductVariation
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection(new ProductVariationEntityFactory()),
					ProductEntity.Relations.ProductVariationEntityUsingProductId, 
					(int)DirectSports.BL.EntityType.ProductEntity, (int)DirectSports.BL.EntityType.ProductVariationEntity, 0, null, null, null, null, "ProductVariation", RelationType.OneToMany);
			}
		}
		...
		/// <summary> The SortIndex property of the Entity Product<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Product"."SortIndex"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.Int16 SortIndex
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductFieldIndex.SortIndex);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)ProductFieldIndex.SortIndex, value); }
		}

		/// <summary> The Enabled property of the Entity Product<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Product"."Enabled"<br/>
		/// Table field type characteristics (type, precision, scale, length): Boolean, 0, 0, 2<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean Enabled
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductFieldIndex.Enabled);
				if(valueToReturn == null)
				{
					valueToReturn = TypeDefaultValue.GetDefaultValue(typeof(System.Boolean));
				}
			...
			set	{ SetNewFieldValue((int)ProductFieldIndex.Enabled, value); }
		}
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'ProductVariationEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(ProductVariationEntity))]
		public virtual EntityCollection ProductVariation
		{
			get
			{
				if(_productVariation==null)
				{
					_productVariation = new EntityCollection(new ProductVariationEntityFactory());
					_productVariation.SetContainingEntityInfo(this, "Product");
				}
