...
namespace DirectSports.BL.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ProductVariation'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ProductVariationEntity : EntityBase2, ISerializable
			...
			
	{
		...
		/// <summary> Event which is thrown when Text changes value. Databinding related.</summary>
		public event EventHandler TextChanged;

		#endregion
		
		/// <summary> Static CTor for setting up custom property hashtables. Is executed before the first instance of this entity class or derived classes is constructed. </summary>
		static ProductVariationEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ProductVariationEntity():base("ProductVariationEntity")
		{
		...
		public ProductVariationEntity(IEntityFields2 fields):base("ProductVariationEntity")
		{
			InitClassEmpty(CreateValidator(), fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ProductVariationEntity</param>
		public ProductVariationEntity(ProductVariationValidator validator):base("ProductVariationEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="id">PK value for ProductVariation which data should be fetched into this ProductVariation object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ProductVariationEntity(System.Int32 id):base("ProductVariationEntity")
		{
			InitClassEmpty(CreateValidator(), CreateFields());
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this ProductVariationEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ProductVariationEntity(System.Int32 id, ProductVariationValidator validator):base("ProductVariationEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.Id = id;
		}
		...
		protected ProductVariationEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("ProductVariationEntity", ((DirectSports.BL.EntityType)typeOfEntity).ToString());
		}
		...
		/// <summary> Event thrower for the TextChanged event, which is thrown when Text changes value. Databinding related.</summary>
		...
		{
			return new ProductVariationEntityFactory();
		}
		...
		private void DesetupSyncProduct(bool signalRelatedEntity)
		{
			if(_product != null)
			{
				...
				_product.AfterSave-=new EventHandler(OnEntityAfterSave);
				base.UnsetEntitySyncInformation("Product", _product, ProductVariationEntity.Relations.ProductEntityUsingProductId);
				if(signalRelatedEntity)
				{
					_product.UnsetRelatedEntity(this, "ProductVariation");
				}
				SetNewFieldValue((int)ProductVariationFieldIndex.ProductId, null);
				_product = null;
			}
		}
		...
		private void SetupSyncProduct(IEntity2 relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_product.ActiveContext = base.ActiveContext;
				_product.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("Product", _product, ProductVariationEntity.Relations.ProductEntityUsingProductId);
		...
		/// <param name="validator">The validator object for this ProductVariationEntity</param>
		...
		public  static ProductVariationRelations Relations
		{
			get	{ return new ProductVariationRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathProduct
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(new ProductEntityFactory()),
					ProductVariationEntity.Relations.ProductEntityUsingProductId, 
					(int)DirectSports.BL.EntityType.ProductVariationEntity, (int)DirectSports.BL.EntityType.ProductEntity, 0, null, null, null, null, "Product", RelationType.ManyToOne);
			}
		}
		...
		{
			get { return ProductVariationEntity.CustomProperties;}
		}
		...
		{
			get { return ProductVariationEntity.FieldsCustomProperties;}
		}

		/// <summary> The Id property of the Entity ProductVariation<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ProductVariation"."Id"<br/>
		...
		public virtual System.Int32 Id
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVariationFieldIndex.Id);
			...
			set	{ SetNewFieldValue((int)ProductVariationFieldIndex.Id, value); }
		}

		/// <summary> The ProductId property of the Entity ProductVariation<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ProductVariation"."ProductId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Integer, 10, 0, 0<br/>
		...
		public virtual System.Int32 ProductId
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVariationFieldIndex.ProductId);
				if(valueToReturn == null)
				{
					valueToReturn = TypeDefaultValue.GetDefaultValue(typeof(System.Int32));
				}
			...
			set	{ SetNewFieldValue((int)ProductVariationFieldIndex.ProductId, value); }
		}

		/// <summary> The Price property of the Entity ProductVariation<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ProductVariation"."Price"<br/>
		...
		public virtual System.Decimal Price
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVariationFieldIndex.Price);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)ProductVariationFieldIndex.Price, value); }
		}

		/// <summary> The PriceIncludesVat property of the Entity ProductVariation<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ProductVariation"."PriceIncludesVAT"<br/>
		...
		public virtual System.Boolean PriceIncludesVat
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVariationFieldIndex.PriceIncludesVat);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)ProductVariationFieldIndex.PriceIncludesVat, value); }
		}

		/// <summary> The PriceIsFrom property of the Entity ProductVariation<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ProductVariation"."PriceIsFrom"<br/>
		/// Table field type characteristics (type, precision, scale, length): Boolean, 0, 0, 2<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean PriceIsFrom
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVariationFieldIndex.PriceIsFrom);
				if(valueToReturn == null)
				{
					valueToReturn = TypeDefaultValue.GetDefaultValue(typeof(System.Boolean));
				}
			...
			set	{ SetNewFieldValue((int)ProductVariationFieldIndex.PriceIsFrom, value); }
		}

		/// <summary> The Text property of the Entity ProductVariation<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ProductVariation"."Text"<br/>
		...
		public virtual System.String Text
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVariationFieldIndex.Text);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)ProductVariationFieldIndex.Text, value); }
		}
		...
		public virtual ProductEntity Product
		{
			...
			set
			{
				...
				else
				{
					...
					{
						((IEntity2)value).SetRelatedEntity(this, "ProductVariation");
					}
				}
			}
		}
		...
		{ 
			get { return (int)DirectSports.BL.EntityType.ProductVariationEntity; }
		}
		#endregion
