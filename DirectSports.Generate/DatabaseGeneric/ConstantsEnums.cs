...
namespace DirectSports.BL
{
	...
	/// <summary>
	/// Index enum to fast-access EntityFields in the IEntityFields collection for the entity: ProductVariation.
	/// </summary>
	public enum ProductVariationFieldIndex:int
	{
		///<summary>Id. </summary>
		Id,
	...
	public enum EntityType:int
	{
		...
		///<summary>ProductVariation</summary>
